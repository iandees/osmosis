...
package org.openstreetmap.osmosis.json.common;
...
public abstract class BaseJsonWriter {
	...
	private static Logger log = Logger.getLogger(BaseJsonWriter.class.getName());
	 ...
	 */
	public BaseJsonWriter(BufferedWriter writer) {
		this.writer = writer;
	 ...
	 */
	public BaseJsonWriter(File file, CompressionMethod compressionMethod) {
		this.file = file;
